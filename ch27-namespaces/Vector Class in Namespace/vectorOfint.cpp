...
namespace brandonsIntVector
{
    ...
    vectorOfInt& vectorOfInt::operator= (const vectorOfInt &originalVec)
    {
        ...
        //if this function was returned by value, it would invoke the copy constructor, then return, then destroy the object copy
